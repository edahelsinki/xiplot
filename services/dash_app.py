    ...
    children=[
            ...
            [
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Dropdown(
                                    data_files, id="data_files", clearable=False
                                ),
                            ],
                            style={
                                "width": "98%",
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                html.Div([html.H6("Column")]),
                                html.Div(
                                    [
                                        dcc.Dropdown(
                                            id="selected_data_column", clearable=False
                                        )
                                    ],
                                    style={"width": "98%"},
                                ),
        ...
        html.Div(
            [
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Dropdown(
                                    id="selected_histogram_column", clearable=False
                                )
                            ]
                        ),
                    ],
                ...
                html.Div([dcc.Graph(id="selected_histogram")]),
            ],
            style={"width": "33%", "display": "inline-block", "float": "left"},
        ),
        html.Div([html.Div(id="smiles_image")], style={"float": "left"}),
    ]
)
