...
def generate_id(
    ...
    Since the type of the id is based on an actual type there is less chance for overloading and better refactoring resistance.
    ...
    if cls in [MATCH, ALL, ALLSMALLER]:
        ...
        classtype = f"{cls.__module__}_{cls.__qualname__}_{subtype}".replace(".", "_")
    if index is None:
